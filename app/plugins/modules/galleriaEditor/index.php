...
<div class='photoList ui-widget-header' style='width:100%;height:100%;background:white;'>
	<div id=photoViewer style='width:52%;height:100%;float:left;overflow:hidden;'>
		...
		<div class='tools ui-widget-header ui-corner-all'>
			...
			<button class='right' title='Save' onclick="saveDescription()"><div class='bigsaveicon'>&nbsp;</div></button>
			<textarea id=photoDescription class='photoDescription' class='ui-widget-content' style='width:50%;height:50px;border:1px solid #aaa;margin:4px;resize:none;float:right;' readonly></textarea>
		</div>
	</div>
	<div style='width:45%;height:100%;float:right;overflow:hidden;'>
		...
		<div id=uploadForm style='width:99%;height:30%;' align=center>
			...
			<form method=POST onsubmit="return checkFile();" enctype="multipart/form-data" target="upload_frame" 
				action="services/?scmd=galleriaEditor&forsite=<?=$_REQUEST["forsite"]?>&action=upload&js=clearUploadForm">
...
lnk="services?scmd=galleriaEditor&forsite=<?=$_REQUEST["forsite"]?>";
var photoSet="";
var lastPhoto="";
