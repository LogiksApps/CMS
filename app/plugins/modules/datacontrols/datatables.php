...
_js(array("jquery.multiselect","jquery.listAttributes","jquery.editinplace"));
...
curSite="<?=SITENAME?>";
lnkLst="services/?scmd=datacontrols.lists&mode=<?=$_REQUEST["mode"]?>&site=<?=SITENAME?>&forsite="+site;
engine="";
...
$(function() {
	...
	$("#designer").css("width",($(window).width()-$("#sidebar").width()-30)+"px");
