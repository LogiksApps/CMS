...
function loadList() {
	...
	processAJAXQuery(_service("settingsApps","getlist"),function(data) {
		$("#componentTree").html("");
...
function loadConfig(src, title) {
	...
	$("#pgcontent").load(_service("settingsApps","fetch","html")+"&src="+currentSRC,function() {
...
function saveConfig(ele) {
	...
	if(value!=oldvalue) {
		lx=_service("settingsApps","save","html")+"&src="+currentSRC;
