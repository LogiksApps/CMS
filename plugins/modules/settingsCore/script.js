...
function loadList() {
	...
	processAJAXQuery(_service("settingsCore","getlist"),function(data) {
		$("#componentTree").html("");
...
function loadConfig(src, title) {
	...
	$("#pgcontent").load(_service("settingsCore","fetch","html")+"&src="+currentSRC,function() {
...
function saveConfig(ele) {
	...
	if(value!=oldvalue) {
		lx=_service("settingsCore","save","html")+"&src="+currentSRC;
