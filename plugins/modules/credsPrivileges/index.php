...
// 			"generateRoles"=>["icon"=>"<i class='fa fa-random'></i>","tips"=>"Generate New Roles"],
			['type'=>"bar"],
			"showInfo"=>["icon"=>"<i class='fa fa-info-circle'></i>"],
...
echo _js(["credsPrivileges"]);
?>
<script>
function showInfo() {
    
    lgksAlert(`Set <b>USE_PRIVILEGE_FOR_PERMISSIONS=true</b> in your config use privileges instead of Roles<br>
            Set <b>SECURITY_POLICY_CREATE_NOTFOUND=true</b> in your config to auto create first time used Privilege Controls<br>
            Set <b>SECURITY_POLICY_DEFAULT_ALLOW=true</b> in your config to set default allow policy for auto created privileges<br>`, "How to use!");
}    
</script>