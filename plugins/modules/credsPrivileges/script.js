...
$(function() {
  ...
  $("#roleModel").delegate("input[name=checkAll]","change",function(e) {
			...
			$(this).closest(".panel.panel-default").find("input[name=roleCheckbox]").each(function() {
				...
				processAJAXPostQuery(_service("credsPrivileges","save"),roleHash+"="+uniStatus,function(ans) {
					try {
						json=$.parseJSON(ans);
	...
	$("#roleModel").delegate("input[name=roleCheckbox]","change",function(e) {
		...
		processAJAXPostQuery(_service("credsPrivileges","save"),roleHash+"="+status,function(ans) {
			try {
				json=$.parseJSON(ans);
				if(json.Data=="success") {
					lgksToast("Updated");
...
function loadPrivilegeList() {
  ...
  processAJAXQuery(_service("credsPrivileges","list-privileges"),function(data) {
        html=[];
...
function loadRoleModel(roleID) {
  ...
  processAJAXPostQuery(_service("credsPrivileges","list-roles"),"&roleid="+roleID,function(data) {
