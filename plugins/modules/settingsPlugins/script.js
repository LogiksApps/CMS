...
function loadList() {
	...
	processAJAXQuery(_service("settingsPlugins","getlist"),function(data) {
		$("#componentTree").html("");
...
function loadConfig(src, title) {
	...
	$("#pgcontent").load(_service("settingsPlugins","fetch","html")+"&src="+currentSRC,function() {
...
function saveConfig(ele) {
	...
	if(value!=oldvalue) {
		lx=_service("settingsPlugins","save","html")+"&src="+currentSRC;
